...
public class CozeLoopSpan implements AutoCloseable {
     ...
     */
    public CozeLoopSpan(Span span, Scope scope, ContextPropagators propagators, Context context, String scene) {
        this.span = span;
        this.scope = scope;
     ...
     * You can find recommended specification in https://github.com/coze-dev/cozeloop-java/tree/main/cozeloop-core/src/main/java/com/coze/loop/spec/tracespec.
...
//    }
    ...
    public CozeLoopSpan setModelFrequencyPenalty(Double frequencyPenalty) {
        if (frequencyPenalty!= null) {
            span.setAttribute(AttributeKey.doubleKey(SpanKeys.GEN_AI_REQUEST_FREQUENCY_PENALTY), frequencyPenalty);
        }
        return this;
    }
    ...
    public CozeLoopSpan setModelPresencePenalty(Double presencePenalty) {
        if (presencePenalty!= null) {
            span.setAttribute(AttributeKey.doubleKey(SpanKeys.GEN_AI_REQUEST_PRESENCE_PENALTY), presencePenalty);
        }
        return this;
    }
    ...
    public CozeLoopSpan setModelStopSequences(List<String> stopSequences) {
        if (stopSequences != null && !stopSequences.isEmpty()) {
            span.setAttribute(AttributeKey.stringArrayKey(SpanKeys.GEN_AI_REQUEST_STOP_SEQUENCES), stopSequences);
        }
        return this;
    }
    ...
    /**
     * Set baggage for this span and future child spans.
     * Baggage is automatically propagated across service boundaries.
     *
    ...
    public CozeLoopSpan setBaggage(Map<String, String> values) {
        if (values != null && !values.isEmpty()) {
            io.opentelemetry.api.baggage.BaggageBuilder builder = Baggage.fromContext(context).toBuilder();
