...
public final class ValidationUtils {
  ...
  public static void requireNonEmpty(String value, String paramName) {
    if (value == null || value.trim().isEmpty()) {
      throw new CozeLoopException(
          ErrorCode.INVALID_PARAM, paramName + " must not be null or empty");
    }
  }
  ...
  public static void requireNonNull(Object value, String paramName) {
    if (value == null) {
      throw new CozeLoopException(ErrorCode.INVALID_PARAM, paramName + " must not be null");
    }
  }
  ...
  public static void requirePositive(long value, String paramName) {
    if (value <= 0) {
      throw new CozeLoopException(ErrorCode.INVALID_PARAM, paramName + " must be positive");
    }
  }
  ...
  public static void requireNonNegative(long value, String paramName) {
    if (value < 0) {
      throw new CozeLoopException(ErrorCode.INVALID_PARAM, paramName + " must be non-negative");
    }
  }
