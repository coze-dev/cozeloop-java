...
/**
 * Annotation to automatically create a trace span for a method. Supports SpEL expressions for
 * dynamic span names and input/output capture.
 */
...
public @interface CozeTrace {
  ...
  /**
   * Span name. Supports SpEL expressions. Example: "llm_call_#{#args[0]}" or
  ...
  /**
   * Whether to capture method arguments as span input. If true, all arguments will be serialized to
   * JSON.
   *
   ...
   * array), #arg0, #arg1, ... (individual arguments) Example: "#args[0].query" or "#arg0"
   *
  ...
  /**
   * SpEL expression to extract output from method context. Available variables: #result (return
   * value) Example: "#result.data" or "#result.toString()"
   *
