 ...
 * 
 * <p>This example uses the spring-boot-starter module, which automatically 
 * configures the CozeTraceAspect to handle the @CozeTrace annotation.
 */
...
public class AnnotationTraceExample {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("cozeloop.workspace-id", "7491559619156901903");
        System.setProperty("cozeloop.auth.token", "pat_VU2iDtiVZclETcRiyzdkjLo4FElAAwpYJxFCS5aWhGWNRW0KNvz3X3qGCFqk8M63");

        ConfigurableApplicationContext context = SpringApplication.run(AnnotationTraceExample.class, args);
    ...
    public static class LlmService {
         ...
         * #arg0, #arg1 refers to method arguments.
         * #args[n] also works.
         */
        @CozeTrace(
